...
import com.google.idea.blaze.base.util.PathUtil;
...
final class NonProblemFilterWrapper implements Filter, PossiblyDumbAware {
  ...
  public Result applyFilter(String line, int entireLength) {
    // Blaze error message uses absolute path for BUILD files. If it's not processed by {@link
